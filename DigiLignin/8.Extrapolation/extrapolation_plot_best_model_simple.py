# -*- coding: utf-8 -*-
"""
Extrapolation Plot for Best Model (5 features) - Simplified Version
...
def create_extrapolation_plot(csv_filename='closest_inputs_best_model.csv', 
    ...
    ax_inset1.set_title('Low Tg Region', fontsize=16)
    ...
    ax_inset2.set_title('High Tg Region', fontsize=16)
